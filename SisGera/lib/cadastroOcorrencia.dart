...
class _Ocorrencia extends State<Ocorrencia>{
  ...
  Future<void> _saveForm() async {
    ...
    try {
      ...
      Navigator.pop(context, 'Ocorrência registrada com sucesso!');
    } catch (error) {
                    ...
                    child: Column(
                      children: <Widget>[
                        Padding(
                            ...
                            child:Text('Registrar Ocorrência',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),)
                        ),
                        Divider(
                          color: primaryColor,
                          thickness: 5.0,
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            validator: (value){
                              if(value!.isEmpty){
                                return 'Informe a equipe em plantão';
                              }
                            },
                        ...
                        RadioListTile<Tipo>(
                          title: const Text('Combate á Incêndio'),
                          value: Tipo.incendio,
                          groupValue: _tipo,
                          onChanged: (Tipo? value) {
                            setState((){
                              _tipo = value!;
                              tipoocorrencia = 'Combate á Incêndio';
                            });
                          },
                        ),
                        RadioListTile<Tipo>(
