...
class EditCorpo extends StatefulWidget{
  Corpo createState()=> Corpo();
}

class Corpo extends State<EditCorpo>{
  ...
  Future<void> _saveForm() async {
    ...
    try {
      await products.updateCorpo(product);
      Navigator.pop(context, 'Corporação atualizada com sucesso!');
    } catch (error) {
                  ...
                  child: Column(
                    children: <Widget>[
                      Padding(
                          ...
                          child:Text('Editar Corporação',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 16),)
                      ),
                      Divider(
                        color: primaryColor,
                        thickness: 5.0,
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          onSaved: (value) => _formData['numero'] = value!,
                            initialValue: CORPO.numero.toString()
                        ),
                      ),
