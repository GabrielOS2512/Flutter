...
import 'package:pdm_sisgera/cadastroOcorrencia.dart';
...
class ListaOcorrencia extends StatelessWidget{
  Future<void> _refreshBO(BuildContext context) {
    return Provider.of<Ocos>(context, listen: false).carregarBO();
  }
...
class BOItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      onTap: (){
        Navigator.of(context).pushNamed(AppRoutes.DETALHESOCO, arguments: BOLETIM);
      },
    );
  }
}